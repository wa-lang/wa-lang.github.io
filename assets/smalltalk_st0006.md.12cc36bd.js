import{_ as s,c as a,o as n,a as l}from"./app.a93e6577.js";const p="/st0006.png",f=JSON.parse('{"title":"凹语言 支持浏览器环境构建","description":"","frontmatter":{},"headers":[],"relativePath":"smalltalk/st0006.md"}'),o={name:"smalltalk/st0006.md"},e=l('<h1 id="凹语言-支持浏览器环境构建" tabindex="-1">凹语言 支持浏览器环境构建 <a class="header-anchor" href="#凹语言-支持浏览器环境构建" aria-hidden="true">#</a></h1><ul><li>时间：2022-09-16</li><li>撰稿：凹语言 开发组</li><li>转载请注明原文链接：<a href="https://wa-lang.org/smalltalk/st0006.html" target="_blank" rel="noreferrer">https://wa-lang.org/smalltalk/st0006.html</a></li></ul><hr><p>凹语言最新发布了 <a href="https://github.com/wa-lang/wa/releases/tag/v0.2.1" target="_blank" rel="noreferrer">v0.2.1</a> 版本，经过小伙伴们的通力合作，终于可以在浏览器环境编译并执行（不依赖后台服务）。Playground 在线地址 <a href="https://wa-lang.org/playground" target="_blank" rel="noreferrer">https://wa-lang.org/playground</a>，以下是执行效果：</p><p><img src="'+p+`" alt=""></p><p>本地安装最新的 凹语言™ v0.2.1 版本：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki" style="background-color:#2e3440ff;"><code><span class="line"><span style="color:#d8dee9ff;">$ go install gitee.com/wa-lang/wa@v0.2.1</span></span>
